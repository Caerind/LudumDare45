...
private:
    ...
    static constexpr en::MetaDataType s_MetaData = en::MetaDataType(en::Hash::CRC32("MyEnum"), "MyEnum", ENLIVE_SIZE_OF(en::U32), ENLIVE_ALIGN_OF(en::U32), en::TypeTraits_Enum, nullptr, nullptr, 0, en::Attribute_None, &s_MetaDataEnum);
};
...
private:
	...
	static constexpr en::MetaDataType s_MetaData = en::MetaDataType(en::Hash::CRC32("TestClassA"), "TestClassA", ENLIVE_SIZE_OF(en::TestClassA), ENLIVE_ALIGN_OF(en::TestClassA), en::TypeTraits_Class, nullptr, s_MetaDataProperties, ENLIVE_ARRAY_SIZE(s_MetaDataProperties));
};
