...
#define ENLIVE_DEFINE_TYPE_TRAITS_TYPE(name, expr) \
	...
	ENLIVE_DEFINE_TYPE_TRAITS_VALUE(IsAssignable, std::is_assignable<T>::value);
	ENLIVE_DEFINE_TYPE_TRAITS_VALUE(IsTriviallyAssignable, std::is_trivially_assignable<T>::value);
	ENLIVE_DEFINE_TYPE_TRAITS_VALUE(IsNothrowAssignable, std::is_nothrow_assignable<T>::value);
	...
	ENLIVE_DEFINE_TYPE_TRAITS_VALUE(IsSwappableWith, std::is_swappable_with<T>::value);
	ENLIVE_DEFINE_TYPE_TRAITS_VALUE(IsSwappable, std::is_swappable<T>::value);
	ENLIVE_DEFINE_TYPE_TRAITS_VALUE(IsNothrowSwappableWith, std::is_nothrow_swappable_with<T>::value);
	...
	ENLIVE_DEFINE_TYPE_TRAITS_VALUE_2(IsNothrowConvertible, (std::is_nothrow_convertible<T1, T2>::value)); // T1:From, T2:To
